    ...
    try {
      switch (event.action) {
        ...
        case GovernorAction.FULL_RECOVERY:
          ...
          // case'indeki HTTP_429 tip-guard'ıyla aynı desen: markFailed SADECE gerçek
          // anomaly AUTH_VALIDATION_FAILED DEĞİLSE çağrılır (aksi halde sağlıklı bir
          // proxy, session/auth sorununda yanlışlıkla karantinaya girer — yanlış
          // telemetri, Madde 22 disiplini ihlali).
